...
- [Person Counter App](https://github.com/Saqlain-qark/Counter-App) - A simple web application that allows users to count the number of people entering a space and save the count for future reference.  You can see a description demo of the app [here](https://saqlain-qark.github.io/Counter-App/). (currently optimised for desktop only).

- [BlackJack-Game](https://github.com/Saqlain-qark/BlackJack-Game) - This is a simple implementation of the Blackjack game in HTML, CSS, and JavaScript. You can see a demo of the game [here](https://saqlain-qark.github.io/BlackJack-Game/). (currently optimised for desktop only).
